...
public class Defensa2ParaleloC {
    ...
    public static void main(String[] args) {
		...
		System.out.println("------------------------------------------------------");
	     ...
	     Museo M1=new Museo(29,"Miraflores","Av. Del Ejército","ESPACIO DE LA MEMORIA HISTÓRICA DE LAS LUCHAS DEL PUEBLO BOLIVIANO POR LA LIBERTAD Y LA DEMOCRACIA");
	     Museo M2=new Museo(20, "Centro", "Calle Linares 906", "EXPOSICIÓN Y VENTA DE TEXTILES ANDINOS");	    
	     Museo M3=new Museo(21, "Sopocachi", "Plaza Isabel La Católica s/n", "EXPOSICIÓN DE ARTE CONTEMPORÁNEO");	     
	     Museo M4=new Museo(22, "Miraflores", "Calle Ingavi s/n", "EXPOSICIÓN DE ARTEFACTOS ARQUEOLÓGICOS PREHISPÁNICOS");	     
	     Museo M5=new Museo(23, "San Pedro", "Calle Linares 906", "EXPOSICIÓN DE LA HISTORIA, USO Y CULTIVO DE LA COCA");	    
	     Museo M6=new Museo(24, "Sopocachi", "Calle Capitán Castrillo s/n", "EXPOSICIÓN DE LA HISTORIA DEL LITORAL BOLIVIANO");	     
	     Museo M7=new Museo(25, "San Francisco", "Calle Jaén 711", "EXPOSICIÓN DE INSTRUMENTOS MUSICALES BOLIVIANOS");	     
	     Museo M8=new Museo(26, "San Jorge", "Calle Comercio 1472", "EXPOSICIÓN DE ARTE BOLIVIANO E INTERNACIONAL");	     
	     Museo M9=new Museo(27, "San Jorge", "Calle Comercio 1472", "EXPOSICIÓN DE LA HISTORIA DE LA REVOLUCIÓN BOLIVIANA");	     
	     Museo M0=new Museo(28, "Cotahuma", "Calle 21 de Mayo s/n", "EXPOSICIÓN DE LA CULTURA DE LA COCA Y LA IDENTIDAD BOLIVIANA");   
